...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['ball_carrier_id'], ['players.player_id'], ),
    sa.ForeignKeyConstraint(['foul_player_id_1'], ['players.player_id'], ),
    sa.ForeignKeyConstraint(['foul_player_id_2'], ['players.player_id'], ),
    sa.ForeignKeyConstraint(['game_id'], ['games.game_id'], ),
    sa.ForeignKeyConstraint(['los_team_id'], ['teams.team_id'], ),
    sa.ForeignKeyConstraint(['offensive_team_id'], ['teams.team_id'], ),
    sa.PrimaryKeyConstraint('play_id')
    )
    op.create_table('tackles',
    ...
    sa.ForeignKeyConstraint(['play_id'], ['plays.play_id'], ),
